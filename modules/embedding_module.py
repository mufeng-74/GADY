...
class EmbeddingModule(nn.Module):
  ...
  def compute_neg_embedding(self, memory, source_nodes, timestamps, n_layers, n_neighbors=20, time_diffs=None,
                        use_time_proj=True, V=None, R=None):
    pass
...
class GraphEmbedding(EmbeddingModule):
  ...
  def compute_neg_embedding(self, memory, source_nodes, timestamps, n_layers, n_neighbors=20, time_diffs=None,
    ...
    # neighbors_torch together with source_nodes_torch is what we want
      ...
      neighbor_embeddings = self.compute_neg_embedding(memory,
                                                   neighbors,
  ...
  def aggregate(self, n_layers, source_node_features, 
                neighbor_embeddings,
                edge_features, mask, timestamps, V=None, R=None,src_idx=None, neigh_idx=None,
                roots=None, targets=None, node_level=False):
    return None


class GADY(GraphEmbedding):
  def __init__(self, node_features, edge_features, neighbor_finder, time_encoder, n_layers,
               n_node_features, n_edge_features, n_time_features, embedding_dimension, device,
               use_memory=True, beta=0.1, r_dim=4):
    super(GADY, self).__init__(node_features=node_features,
  ...
  def aggregate(self, n_layer, source_node_features,
                neighbor_embeddings,
                edge_features, mask, timestamps, V=None, R=None, src_idx=None, neigh_idx=None,
                roots=None, targets=None, node_level=False):
...
def get_embedding_module(module_type, node_features, edge_features, neighbor_finder,
                         ...
                         use_memory=True, beta=0.1, r_dim=4):
  if module_type == "GADY":
    return GADY(node_features=node_features,
                              edge_features=edge_features,
                              neighbor_finder=neighbor_finder,
